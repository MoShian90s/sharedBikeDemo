/**
     ...
     google.maps.event.addListener(me.marker_.getMap(), "mousemove", function(mEvent) {
       ...
       if (cMouseIsDown) {
         if (cDraggingLabel) {
           ...
           mEvent.latLng = new google.maps.LatLng(mEvent.latLng.lat() - cLatOffset, mEvent.latLng.lng() -
             cLngOffset);
 ...
 MarkerLabel_.prototype.setMandatoryStyles = function() {
   ...
   if (typeof this.labelDiv_.style.opacity !== "undefined" && this.labelDiv_.style.opacity !== "") {
     this.labelDiv_.style.MsFilter = "\"progid:DXImageTransform.Microsoft.Alpha(opacity=" + (this.labelDiv_.style.opacity *
       100) + ")\"";
